...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const beforeCtgValue = "${post.category}";
    $("#ctgSlt").val(beforeCtgValue);
    ...
    const beforesubctgValue = "${post.subCategory}";
    $("#subCtgSlt").val(beforesubctgValue);
    
    updateTypeSlt(); // type option 채우기 (disabled 해제)

    const beforeTypeValue = "${post.type}";
    $("#typeSlt").val(beforeTypeValue);
});
